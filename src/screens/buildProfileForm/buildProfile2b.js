...
function BuildProfile2({ navigation }) {
  ...
  const handleSubmit = async() => {
    ...
    const user = {id: userObj.id, interests_learn_more: arr};
    const updatedUser = await API.graphql(graphqlOperation(updateUser, {input: user}));
    console.log('updated user: ', updatedUser);

    navigation.navigate('BuildProfile3');
  }
  ...
  return (
    <SafeAreaView style={GlobalStyles.droidSafeArea}>
        ...
        <Text style={styles.boldText}><B>I am curious to learn more about these areas of advocacy:</B></Text>
